...
export default function fetchPost() {
    ...
    const fetchPosts = async (reset = false) => {
        try {
            ...
            const savedPosts: string[] = profileData?.saved_posts ?? [];
            ...
            const postsWithMeta = await Promise.all(posts.map(async post => {
                ...
                const [{ count: likes = 0 }, { count: comments = 0 }, { data: likeRecord }] = await Promise.all([
                ...
                return {
                    ...
                    saved_by_user: savedPosts.includes(post.id), // ✅ New field
